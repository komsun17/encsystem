      ...
      var e = {
            ...
            var n = {},
              o = (function () {
                ...
                return (
                  ...
                  Object.defineProperty(t.prototype, "lineHeightFactor", {
                    get: function () {
                  ...
                  (t.prototype.getLineHeight = function (t) {
                    return (t / this.scaleFactor()) * this.lineHeightFactor;
                  }),
          ...
          49: function (t, e, n) {
            ...
            function d(t, e, n, o, i, a, s) {
              ...
              if (n.canEntireRowFit(c, s)) h(t, e, n, a, s);
              else if (
                (function (t, e, n, o) {
                ...
                var g = (function (t, e, n, o) {
                  ...
                  for (var a = 0, s = 0, d = n.columns; s < d.length; s++) {
                    var h = d[s];
                    if ((b = t.cells[h.index])) {
                      Array.isArray(b.text) || (b.text = [b.text]);
                      var c = new r.Cell(b.raw, b.styles, b.section);
                      (c = (0, l.assign)(c, b)).text = [];
                      var f = u(b, e, o);
                      b.text.length > f &&
                        (c.text = b.text.splice(f, b.text.length));
                      var g = o.scaleFactor(),
                        p = o.lineHeightFactor;
                      (b.contentHeight = b.getContentHeight(g, p)),
                        ...
                        (c.contentHeight = c.getContentHeight(g, p)),
                        c.contentHeight > a && (a = c.contentHeight),
                        (i[h.index] = c);
                    }
                  }
                  ...
                  for (var v = 0, m = n.columns; v < m.length; v++) {
                    var b;
                    (h = m[v]),
                      (c = y.cells[h.index]) && (c.height = y.height),
                      (b = t.cells[h.index]) && (b.height = t.height);
                  }
                  return y;
                })(n, c, e, t);
                h(t, e, n, a, s), f(t, e, i, a, s), d(t, e, g, o, i, a, s);
              } else f(t, e, i, a, s), d(t, e, n, o, i, a, s);
            }
            ...
            (e.drawTable = function (t, e) {
              var n = e.settings,
                ...
                p = r + a.bottom + c;
              "avoid" === n.pageBreak &&
                (p += e.body.reduce(function (t, e) {
                  return t + e.height;
                }, 0));
              var y = new i.DocHandler(t);
              ("always" === n.pageBreak ||
                (null != n.startY && p > y.pageSize().height)) &&
                (g(y), (u.y = a.top)),
                e.callWillDrawPageHooks(y, u);
              var v = (0, l.assign)({}, u);
              (e.startPageNumber = y.pageNumber()),
                ...
                (0, o.addTableBorder)(y, e, v, u),
                e.callEndPageHooks(y, u),
                (e.finalY = u.y),
                (t.lastAutoTable = e),
