      ...
      $("#formLogin").submit(function(e) {
        ...
        $.ajax({
          ...
          if (resp.status === "success") {
            ...
            setTimeout(() => {
              location.href = '/encsystem/pages/dashboard/';
            }, 800);
          } else {
            toastr.error(resp.message || 'ไม่สามารถเข้าสู่ระบบได้');
          }
        }).fail(function(xhr, status, error) {
          toastr.error('ไม่สามารถเข้าสู่ระบบได้: ' + error);
        });
      });
