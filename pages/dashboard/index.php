                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-primary shadow">
                            <div class="inner text-center">
                                <h1 class="py-3">Prod. Order</h1>
                            </div>
                            <a href="../prodorders/" class="small-box-footer py-3"> Click <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-success shadow">
                            <div class="inner text-center">
                                <h1 class="py-3">Prod. Order Line</h1>
                            </div>
                            <a href="../prodorderlines/" class="small-box-footer py-3"> Click <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- <div class="col-lg-3 col-6">
                        <div class="small-box bg-danger shadow">
                            <div class="inner text-center">
                                <h1 class="py-3">NG List</h1>
                            </div>
                            <a href="../nglists/" class="small-box-footer py-3"> Click <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div> -->
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-warning shadow">
                            <div class="inner text-center">
                                <h1 class="py-3">NG History</h1>
                            </div>
                            <a href="../nghistorys/" class="small-box-footer py-3"> Click <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- <div class="row">
